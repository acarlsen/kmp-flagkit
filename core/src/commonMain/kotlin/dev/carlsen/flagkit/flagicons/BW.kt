...
val FlagIcons.BW: ImageVector
    get() {
        if (_bw != null) {
            return _bw!!
        }
        _bw = Builder(name = "Bw", defaultWidth = 21.0.dp, defaultHeight = 15.0.dp, viewportWidth =
            ...
            path(fill = linearGradient(0.0f to Color(0xFF8BBDEA), 1.0f to Color(0xFF78ABDA), start =
