...
val FlagIcons.PS: ImageVector
    get() {
        if (_ps != null) {
            return _ps!!
        }
        _ps = Builder(name = "Ps", defaultWidth = 21.0.dp, defaultHeight = 15.0.dp, viewportWidth =
            ...
            path(fill = linearGradient(0.0f to Color(0xFF20934F), 1.0f to Color(0xFF197940), start =
            ...
            path(fill = linearGradient(0.0f to Color(0xFFE62539), 1.0f to Color(0xFFCA1A2C), start =
