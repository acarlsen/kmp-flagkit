...
val FlagIcons.NZ: ImageVector
    get() {
        if (_nz != null) {
            return _nz!!
        }
        _nz = Builder(name = "Nz", defaultWidth = 21.0.dp, defaultHeight = 15.0.dp, viewportWidth =
            ...
            path(fill = SolidColor(Color(0xFFCA1931)), stroke = SolidColor(Color(0x00000000)),
