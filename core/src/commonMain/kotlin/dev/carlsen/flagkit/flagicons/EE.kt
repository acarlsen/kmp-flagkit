...
val FlagIcons.EE: ImageVector
    get() {
        if (_ee != null) {
            return _ee!!
        }
        _ee = Builder(name = "Ee", defaultWidth = 21.0.dp, defaultHeight = 15.0.dp, viewportWidth =
            ...
            path(fill = linearGradient(0.0f to Color(0xFF5DA8F1), 1.0f to Color(0xFF4892DA), start =
...
private var _ee: ImageVector? = null
