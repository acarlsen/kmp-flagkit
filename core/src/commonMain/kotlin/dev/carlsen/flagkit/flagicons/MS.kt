...
val FlagIcons.MS: ImageVector
    get() {
        if (_ms != null) {
            return _ms!!
        }
        _ms = Builder(name = "Ms", defaultWidth = 21.0.dp, defaultHeight = 15.0.dp, viewportWidth =
            ...
            path(fill = linearGradient(0.0f to Color(0xFF08B9D6), 1.0f to Color(0xFF00A3BE), start =
            ...
            group {
                path(fill = SolidColor(Color(0xFFA63D09)), stroke = SolidColor(Color(0x00000000)),
            ...
            group {
                path(fill = linearGradient(0.0f to Color(0xFF262626), 1.0f to Color(0xFF0D0D0D),
                        start = Offset(15.5f,5.0f), end = Offset(15.5f,9.0f)), stroke =
                        SolidColor(Color(0x00000000)), strokeLineWidth = 1.0f, strokeLineCap = Butt,
                        strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType = EvenOdd) {
                    moveTo(16.0f, 6.0f)
                    lineTo(16.0f, 5.0f)
