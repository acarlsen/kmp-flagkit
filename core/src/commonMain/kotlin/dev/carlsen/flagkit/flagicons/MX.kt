...
val FlagIcons.MX: ImageVector
    get() {
        if (_mx != null) {
            return _mx!!
        }
        _mx = Builder(name = "Mx", defaultWidth = 21.0.dp, defaultHeight = 15.0.dp, viewportWidth =
            ...
            path(fill = linearGradient(0.0f to Color(0xFFE3283E), 1.0f to Color(0xFFCC162C), start =
            ...
            path(fill = linearGradient(0.0f to Color(0xFF128A60), 1.0f to Color(0xFF0B6848), start =
            ...
            path(fill = SolidColor(Color(0xFF8C9157)), stroke = SolidColor(Color(0x00000000)),
            ...
            path(fill = SolidColor(Color(0xFFC59262)), stroke = SolidColor(Color(0x00000000)),
                    strokeLineWidth = 1.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
