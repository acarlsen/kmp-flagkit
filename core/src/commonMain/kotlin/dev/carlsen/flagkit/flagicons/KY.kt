...
val FlagIcons.KY: ImageVector
    get() {
        if (_ky != null) {
            return _ky!!
        }
        _ky = Builder(name = "Ky", defaultWidth = 21.0.dp, defaultHeight = 15.0.dp, viewportWidth =
            ...
            path(fill = SolidColor(Color(0xFFFAD051)), stroke = SolidColor(Color(0x00000000)),
            ...
            group {
                path(fill = SolidColor(Color(0xFFCF142C)), stroke = SolidColor(Color(0x00000000)),
                        strokeLineWidth = 1.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                        strokeLineMiter = 4.0f, pathFillType = EvenOdd) {
                    moveTo(13.0f, 4.0f)
            ...
            group {
                path(fill = linearGradient(0.0f to Color(0xFF125FBA), 1.0f to Color(0xFF0C50A1),
                        start = Offset(15.5f,6.0f), end = Offset(15.5f,11.0f)), stroke =
                        SolidColor(Color(0x00000000)), strokeLineWidth = 1.0f, strokeLineCap = Butt,
                        strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType = EvenOdd) {
                    moveTo(13.0f, 10.0f)
                    lineTo(18.0f, 10.0f)
