...
val FlagIcons.YE: ImageVector
    get() {
        if (_ye != null) {
            return _ye!!
        }
        _ye = Builder(name = "Ye", defaultWidth = 21.0.dp, defaultHeight = 15.0.dp, viewportWidth =
            ...
            path(fill = linearGradient(0.0f to Color(0xFFE32138), 1.0f to Color(0xFFCC162C), start =
...
private var _ye: ImageVector? = null
