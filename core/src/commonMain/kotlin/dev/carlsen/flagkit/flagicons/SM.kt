...
val FlagIcons.SM: ImageVector
    get() {
        if (_sm != null) {
            return _sm!!
        }
        _sm = Builder(name = "Sm", defaultWidth = 21.0.dp, defaultHeight = 15.0.dp, viewportWidth =
            ...
            path(fill = linearGradient(0.0f to Color(0xFF7CCCF5), 1.0f to Color(0xFF62B7E3), start =
            ...
            path(fill = SolidColor(Color(0xFF445F42)), stroke = SolidColor(Color(0x00000000)),
            ...
            path(fill = SolidColor(Color(0xFFD89F3D)), stroke = SolidColor(Color(0x00000000)),
                    strokeLineWidth = 1.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
