...
val FlagIcons.PN: ImageVector
    get() {
        if (_pn != null) {
            return _pn!!
        }
        _pn = Builder(name = "Pn", defaultWidth = 21.0.dp, defaultHeight = 15.0.dp, viewportWidth =
            ...
            path(fill = linearGradient(0.0f to Color(0xFF1F8BDE), 1.0f to Color(0xFF1075C2), start =
                    Offset(15.5f,6.0f), end = Offset(15.5f,13.0f)), stroke =
                    SolidColor(Color(0x00000000)), strokeLineWidth = 1.0f, strokeLineCap = Butt,
                    strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType = EvenOdd) {
                moveTo(13.0f, 9.5f)
                ...
                lineTo(18.0f, 9.5f)
                curveTo(18.0f, 12.0f, 15.5f, 13.0f, 15.5f, 13.0f)
                curveTo(15.5f, 13.0f, 13.0f, 12.0f, 13.0f, 9.5f)
                close()
            }
            group {
                path(fill = linearGradient(0.0f to Color(0xFFF7E14A), 1.0f to Color(0xFFF7DE38),
                        start = Offset(15.5f,6.0f), end = Offset(15.5f,14.0f)), stroke =
                        SolidColor(Color(0x00000000)), strokeLineWidth = 1.0f, strokeLineCap = Butt,
            ...
            group {
                path(fill = linearGradient(0.0f to Color(0xFF4B8C36), 1.0f to Color(0xFF397127),
                        start = Offset(15.5f,7.118f), end = Offset(15.5f,13.5f)), stroke =
                        SolidColor(Color(0x00000000)), strokeLineWidth = 1.0f, strokeLineCap = Butt,
                        strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                    moveTo(13.0f, 12.118f)
                    lineToRelative(-0.0f, 1.382f)
