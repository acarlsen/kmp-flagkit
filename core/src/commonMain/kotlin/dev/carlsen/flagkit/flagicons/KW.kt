...
val FlagIcons.KW: ImageVector
    get() {
        if (_kw != null) {
            return _kw!!
        }
        _kw = Builder(name = "Kw", defaultWidth = 21.0.dp, defaultHeight = 15.0.dp, viewportWidth =
            ...
            path(fill = linearGradient(0.0f to Color(0xFFD72238), 1.0f to Color(0xFFCC162C), start =
            ...
            path(fill = linearGradient(0.0f to Color(0xFF169A53), 1.0f to Color(0xFF0F7A40), start =
