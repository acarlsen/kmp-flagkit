...
val FlagIcons.SD: ImageVector
    get() {
        if (_sd != null) {
            return _sd!!
        }
        _sd = Builder(name = "Sd", defaultWidth = 21.0.dp, defaultHeight = 15.0.dp, viewportWidth =
            ...
            path(fill = linearGradient(0.0f to Color(0xFFEA1F44), 1.0f to Color(0xFFD01739), start =
            ...
            path(fill = linearGradient(0.0f to Color(0xFF12933B), 1.0f to Color(0xFF0D722D), start =
