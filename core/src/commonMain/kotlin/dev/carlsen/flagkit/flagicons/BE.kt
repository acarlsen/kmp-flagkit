...
val FlagIcons.BE: ImageVector
    get() {
        if (_be != null) {
            return _be!!
        }
        _be = Builder(name = "Be", defaultWidth = 21.0.dp, defaultHeight = 15.0.dp, viewportWidth =
            ...
            path(fill = linearGradient(0.0f to Color(0xFFFF4453), 1.0f to Color(0xFFEE2A39), start =
