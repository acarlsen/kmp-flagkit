...
val FlagIcons.AI: ImageVector
    get() {
        if (_ai != null) {
            return _ai!!
        }
        _ai = Builder(name = "Ai", defaultWidth = 21.0.dp, defaultHeight = 15.0.dp, viewportWidth =
            ...
            group {
                path(fill = SolidColor(Color(0xFF9ACCFF)), stroke = SolidColor(Color(0x00000000)),
                        strokeLineWidth = 1.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                        strokeLineMiter = 4.0f, pathFillType = EvenOdd) {
                    moveTo(13.0f, 9.0f)
            ...
            group {
                path(fill = linearGradient(0.0f to Color(0xFFFFA51B), 1.0f to Color(0xFFFF9A00),
