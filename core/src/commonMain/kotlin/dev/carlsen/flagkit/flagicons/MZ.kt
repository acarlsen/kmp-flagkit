...
val FlagIcons.MZ: ImageVector
    get() {
        if (_mz != null) {
            return _mz!!
        }
        _mz = Builder(name = "Mz", defaultWidth = 21.0.dp, defaultHeight = 15.0.dp, viewportWidth =
            ...
            path(fill = linearGradient(0.0f to Color(0xFFFFE547), 1.0f to Color(0xFFFCE032), start =
            ...
            path(fill = linearGradient(0.0f to Color(0xFF118C81), 1.0f to Color(0xFF0D7168), start =
            ...
            path(fill = linearGradient(0.0f to Color(0xFFEF2147), 1.0f to Color(0xFFD01739), start =
            ...
            path(fill = linearGradient(0.0f to Color(0xFFFDE444), 1.0f to Color(0xFFFCE032), start =
